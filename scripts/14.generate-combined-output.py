...
with open(output_file, 'w') as out:
    out.write('--- Metadata ---\n')
    out.write('Content: Combination of the incus CLI documentation from the `incus --help` \n')
    out.write('Source: Extraction of the `incus --help`\n')
    out.write('Date: %s\n'%date)
    out.write('Author: lxc/incus (linuxcontainers)\n')
    out.write('License: Apache-2.0\n')
    out.write('GeneratedBy: https://github.com/fruafr/incus-doc-cli\n')
    out.write('---\n')
